...
{
    var iframe = document.createElement("iframe"); iframe.setAttribute("border", 0); iframe.className = "AGEWndNoPadding"; iframe.id = "AGEWndIframe"; iframe.name = "AGEWndIframe";
