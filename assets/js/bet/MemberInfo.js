...
Fanex.Customer = {
    SetNextCustomer: function (selectOne, selectTwo, selectThree, currentValue) {
        ...
        var noThree = '';
        var index = 0;
		if (typeof (selectTwo) != 'undefined' && selectTwo != null) {
            selectTwo.options.length = 0;
    ...
    SetAutoUserName: function () {
        ...
        else if (typeof (selectedOne) != 'undefined' && selectedOne!=null && typeof (selectedTwo) != 'undefined' && selectedTwo!=null ) {
            return selectedOne.value + selectedTwo.value;
        }
		else if (typeof (selectedOne) != 'undefined' && selectedOne!=null) {
    ...
    CheckUser: function (username, selectId, select, select2, select3, msgId) {
        if ($(selectId)) {
            $(selectId).onchange = function () {
                ...
                if (typeof ($(select)) != 'undefined' && $(select)!=null && typeof ($(select2)) != 'undefined' && $(select2)!=null && typeof ($(select3)) != 'undefined' && $(select3)!=null) {
                    user += $(select).value + $(select2).value + $(select3).value;
                }
                else if (typeof ($(select)) != 'undefined' && $(select)!=null && typeof ($(select2)) != 'undefined' && $(select2)!=null) {
                    user += $(select).value + $(select2).value;
                }
				else if (typeof ($(select)) != 'undefined' && $(select)!=null) {
                    user += $(select).value;
                }
