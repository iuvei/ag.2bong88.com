...
function ReCheckin() {
    ...
    ajax.PostJSON(age.GetBaseUrl() + 'azkv.php?r=site/RecheckIn', 'onid=' + _page.OnUserID, OnComplete);
}
...
function GetMessages() {
    function completedGetMessages(results) {
        ...
        try {
            ...
            var url = "azkv.php?r=site/MessageHistory&pageQuery=";
    ...
    ajax.PostJSON(age.GetBaseUrl() + 'azkv.php?r=site/GetMessages', '', completedGetMessages);
}
