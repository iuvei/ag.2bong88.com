...
<head>
<title>First Goal / Last Goal</title>
...
<!--<script language="JavaScript" type="text/javascript" src="js/odds/FGLG_Def.js?v=201109160917"></script>-->
<script language="JavaScript" type="text/javascript" src="js/FGLG.js?v=201405280618"></script>
...
<body id="FGLG" onload="refreshData();checkHasParlay('t','1');">
<iframe name='DataFrame' src="" style="display: none"></iframe>
<div class="titleBar">
    <div class="title">Bàn Thắng Đầu/Cuối</div>
    <div class="right">
...
<li  title='Lựa chọn bình thường' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Lựa chọn bình thường</li>
        ...
        <a href="javascript:openLeague(640,'Chọn Giải Đấu','t','1','14,127','0','FGLG');" class="button selectLeague" title="Chọn Giải Đấu">
			<span>
...
<form action="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=site/FGLGData" target="DataFrame" name="DataForm" style="display: none">
	...
	<input type="hidden" name="r" value="site/FGLGData" />
    <input type="hidden" name="MainLeague" value="0" />
    <input type="hidden" name="Page" value="FGLG" />
</form>
