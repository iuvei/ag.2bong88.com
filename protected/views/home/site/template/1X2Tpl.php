...
<table id="tmplTable" class="oddsTable" width="100%" cellpadding="0" cellspacing="0" border="0">
	<tbody id='tmplHeader'>
		<tr valign="middle">
			<th width="6%" rowspan='2' nowrap>Time</th>
			<th width="35%" colspan="2" rowspan='2' align="left" class="even">Event</th>
			<th colspan='3' class="tabthup" title="Toàn Thời Gian">Full time</th>
			<th colspan='3' class="even tabthup tabt_L" title="Hiệp 1">Haft time</th>
	...
	<tbody id='tmplLeague_L'>
		<tr id="l_{%LeagueId}" onclick="refreshData_L()" style="cursor: pointer">
			...
			<td colspan="2" class="tabtitle" align="right" nowrap><a name="btnRefresh_L" class="btnIcon right disable"><div class="icon-refresh" title="Xin vui lòng chờ đợi"></div></a></td>
		</tr>
	</tbody>
	<tbody id='tmplLive'>
		<tr align="center" class="{@Tr_Cls}" onmouseover="this.style.backgroundColor='#f5eeb8';" onmouseout="this.style.backgroundColor='{@BgColor}';">
			...
			<td class="UdrDogTeamClass line_unR" align="left">{%HomeName}<br />{%AwayName}</td>
	...
	<tbody id='tmplLeague'>
		<tr id="l_{%LeagueId}" onclick="refreshData_D()" style="cursor: pointer">
        	<td class="tabtitle"></td>
			<td colspan="7" class="tabtitle">{%LeagueName}</td>
			<td colspan="2" class="tabtitle" align="right" nowrap><a name="btnRefresh_D" class="btnIcon right disable"><div class="icon-refresh" title="Xin vui lòng chờ đợi"></div></a></td>
		</tr>
	</tbody>
	<tbody id='tmplEvent'>
		<tr align="center" class="{@Tr_Cls}" onmouseover="this.style.backgroundColor='#f5eeb8';" onmouseout="this.style.backgroundColor='{@BgColor}';">
