...
<!--<script language="JavaScript" type="text/javascript" src="commJS/odds/Cricket_Def.js?v=201109140231"></script>-->
<script language="JavaScript" type="text/javascript" src="js/Cricket.js?v=201405280618"></script>
...
<body id="Cricket" onload="refreshAll();checkHasParlay('t','27');">
<iframe name='DataFrame_L' src="" style="display: none"></iframe>
<iframe name='DataFrame_D' src="" style="display: none"></iframe>
<div class="titleBar">
    <div class="title">Cricket / Today</div>
    <div class="right">
        <a id="b_SwitchToParlay" href="javascript:SwitchToParlay('27');" class="button mark" style="display:none" title="Parlay"><span>Parlay</span></a>
...
<li  title='Normal Sorting' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Normal Sorting</li>
        ...
        <a href="javascript:openLeague(640,'Select League','t','27','1,2,3,5,20','0','Cricket');" class="button selectLeague" title="Select League">
        	<span>
        ...
        <!--<div id="selOddsType" class="button select"><span>My</span>
            <ul class="submenu">
              <li>My</li>
              <li>Dec</li>
              <li>HK</li>
...
<form action="index.php?r=site/CricketData" target="DataFrame_L" name="DataForm_L" style="display: none">
...
<form action="index.php?r=site/CricketData" target="DataFrame_D" name="DataForm_D" style="display: none">
	<input type="hidden" name="Sport" value="<?php echo $sport ?>" />
