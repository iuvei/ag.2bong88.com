...
<!--<script language="JavaScript" type="text/javascript" src="js/odds/CorrectScore_Def.js?v=201109160917"></script>-->
<script language="JavaScript" type="text/javascript" src="js/CorrectScore.js?v=201405280618"></script>
...
$.src='//v2.zopim.com/?2dKNfgu9rGUygwtfB92UtCP72ojcH8BP';z.t=+new Date;$.
type='text/javascript';e.parentNode.insertBefore($,e)})(document,'script');
</script>
<!--End of Zopim Live Chat Script-->
</head>

<body id="CS" onload="OverWriteFormSubmit();refreshData();checkHasParlay('t','1');">
...
<li  title='Lựa chọn bình thường' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Normal Sorting</li>
	    ...
	    <a href="javascript:openLeague(640,'Chọn Giải Đấu','t','1','4,30','0','CorrectScore');" class="button selectLeague" title="Chọn Giải Đấu">
        	<span>
...
<span  id="disstyle_Txt" title='Toàn Thời Gian'><div id="disstyle_Icon" class="icon_FT"></div></span>
<ul id="disstyle_menu" class="submenu">
<li  title='Toàn Thời Gian' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('disstyle',this,'F',true);changeDisplayMode('F','bong88.com'); parent.focus();"><div class="icon_FT"></div>Full Time</li>
<li  title='Hiệp 1' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('disstyle',this,'H',true);changeDisplayMode('H','bong88.com'); parent.focus();"><div class="icon_HT"></div>Haft Time</li>
</ul>
</div>

	    <a href="#" id="btnRefresh_D" class="button disable" onclick="refreshData();"><span><div class="icon-refresh" title="Xin vui lòng chờ đợi"></div></span></a>
    </div>
</div>
...
<form action="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=site/CorrectScoreData" target="DataFrame" name="DataForm" style="display: none">
