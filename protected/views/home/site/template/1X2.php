...
<!--<script language="JavaScript" type="text/javascript" src="js/odds/1X2_Def.js?v=201109140227"></script>-->
<script language="JavaScript" type="text/javascript" src="js/1X2.js?v=201405280618"></script>
...
<div class="titleBar">
    <div class="title">Match Odds 1X2</div>
    <div class="right">
...
<li  title='Lựa chọn bình thường' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Normal Sorting</li>
        ...
        <a href="javascript:openLeague(640,'Chọn Giải Đấu','t','1','5,15','0','1X2');" class="button selectLeague" title="Chọn Giải Đấu">
        	<span>
        ...
        <a href="javascript:refreshData_D();" id="btnRefresh_D" class="button disable"><span><div class="icon-refresh" title="Xin vui lòng chờ đợi"></div></span></a>
	...
	<div id='OddsTr' style="display: none"><div id="divSelectDate" class="board" style="display:none">
              <ul class="panelInfo">
...
<form action="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=site/1X2Data" target="DataFrame_L" name="DataForm_L" style="display: none">
	...
	<input type="hidden" name="r" value="site/1X2Data" />
    <input type="hidden" name="Page" value="1X2" />
	<input type="hidden" name="key" value="" />
</form>

<form action="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=site/1X2Data" target="DataFrame_D" name="DataForm_D" style="display: none">
	<input type="hidden" name="Sport" value="1"/>
