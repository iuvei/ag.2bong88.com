...
data += '<div class="BetInfo liveligh" onmouseover="this.className=\'BetInfo Ltrbgov\'" onmouseout="this.className=\'BetInfo liveligh\'">';
    data += '<table width="100%" border="0" cellpadding="0" cellspacing="0">';
        ...
        data += '</tr>';
        data += '<tr>';
            data += '<td colspan="2" class="TextStyle02 text-canceled" onmousemove="NumberGroupTitle(this);"> <?php echo $bet->lblChoiceValue ?></td>';
        data += '</tr>';
        data += '<tr>';
        ...
        data += '</tr>';
        data += '<tr>';
            data += '<td colspan="2" class="TextStyle04 text-canceled">';
        ...
        data += '<tr>';
            data += '<td colspan="2" class="TextStyle06">';
                ...
                data += '<div class="right text-ellipsis" style="width:70px; text-align:right; line-height:inherit;" title="Canceled">Canceled</div>';
            data += '</td>';
        data += '</tr>';
    data += '</table>';
data += '</div>';
