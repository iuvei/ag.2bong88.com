...
<script language="JavaScript" type="text/javascript" src="js/NBA.js?v=201310150605"></script>
...
<body id="NBA" onload="refreshAll();checkHasParlay('t','2');">
<iframe name='DataFrame_L' src="" style="display: none"></iframe>
<iframe name='DataFrame_D' src="" style="display: none"></iframe>
<div class="titleBar">
    <div class="title">Basketball / Today</div>
    <div class="right">
        <a id="b_SwitchToParlay" href="javascript:SwitchToParlay('2');" class="button mark" style="display:none" title="Parlay"><span>Parlay</span></a>
...
<li  title='Normal Sorting' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Normal Sorting</li>
        ...
        <a href="javascript:openLeague(640,'Select League','t','2','1,2,3,7,8,12','0','NBA');" class="button selectLeague" title="Select League">
        	<span>
...
<form action="/index.php?r=site/NBAData" target="DataFrame_L" name="DataForm_L" style="display: none">
...
<form action="/index.php?r=site/NBAData" target="DataFrame_D" name="DataForm_D" style="display: none">
	<input type="hidden" name="Sport" value="<?php echo $sport ?>" />
