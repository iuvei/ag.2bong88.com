...
<script language="JavaScript" type="text/javascript" src="js/Tg.js?v=201405280618"></script>
...
<body id="Tg" onload="refreshData();checkHasParlay('t','1');">
<iframe name='DataFrame' src="" style="display: none"></iframe>
<div class="titleBar">
    <div class="title">Tổng Số Bàn Thắng</div>
    <div class="right">
...
<li  title='Lựa chọn bình thường' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Lựa chọn bình thường</li>
        ...
        <a href="javascript:openLeague(640,'Chọn Giải Đấu','t','1','6,126','0','Tg');" class="button selectLeague" title="Chọn Giải Đấu">
        	<span>
...
<form action="index.php?r=site/TgData" target="DataFrame" name="DataForm" style="display: none">
	...
	<input type="hidden" name="r" value="site/TgData" />
