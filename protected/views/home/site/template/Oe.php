...
<!--<script language="JavaScript" type="text/javascript" src="js/odds/OeTg_Def.js?v=201109271047"></script>-->
<script language="JavaScript" type="text/javascript" src="js/Oe.js?v=201405280618"></script>
...
<body id="Oe" onload="refreshData();checkHasParlay('t','1');">
<iframe name='DataFrame' src="" style="display: none"></iframe>
<div class="titleBar">
    <div class="title">FT & HT Odd/Even</div>
    <div class="right">
...
<li  title='Lựa chọn bình thường' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Normal Sorting</li>
        ...
        <a href="javascript:openLeague(640,'Chọn Giải Đấu','t','1','2,12','0','Oe');" class="button selectLeague" title="Chọn Giải Đấu">
        	<span>
...
<form action="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=site/OeData" target="DataFrame" name="DataForm" style="display: none">
	...
	<input type="hidden" name="r" value="site/OeData" />
