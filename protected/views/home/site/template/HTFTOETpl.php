...
<table id="tmplTable" class="oddsTable" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tbody id='tmplHeader'>
    <tr align='center'>
      <th width="6%" nowrap="nowrap" title="Giờ"> Giờ</th>
      <th width="45%" align="left" colspan="2" title="Lựa Chọn" class="even" > Lựa Chọn</th>
      <th width="52" nowrap="nowrap" title="Lẻ/Lẻ"> Lẻ/Lẻ</th>
      <th width="52" nowrap="nowrap" class="even" title="Lẻ/Chẵn"> Lẻ/Chẵn</th>
      <th width="52" nowrap="nowrap" title="Chẵn/Lẻ"> Chẵn/Lẻ</th>
      <th width="52" nowrap="nowrap" class="even" title="Chẵn/Chẵn"> Chẵn/Chẵn</th>
      <th width="1"></th>
    </tr>
  </tbody>
  <tbody id='tmplLeague'>
  ...
  <tbody id='tmplLive'>
    <tr align="center" class="bgcpepk" onmouseover="this.style.backgroundColor='#f5eeb8';"
      ...
      <td align="left" class="UdrDogTeamClass line_unR"> {%HomeName}<br />
        {%AwayName}</td>
