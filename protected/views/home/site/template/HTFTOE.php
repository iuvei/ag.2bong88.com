...
<script language="JavaScript" type="text/javascript" src="js/htftOe.js?v=201408080405"></script>
...
<body id="HtFtOe" onload="refreshData();checkHasParlay('t','1');">
<iframe name='DataFrame' src="" style="display: none"></iframe>
<div class="titleBar">
    <div class="title">HT / FT Odd/Even</div>
    <div class="right">
...
<li  title='Lựa chọn bình thường' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>Lựa chọn bình thường</li>
        ...
        <a href="javascript:openLeague(640,'Chọn Giải Đấu','t','1','6','0','htftoe');" class="button selectLeague" title="Chọn Giải Đấu">
        	<span>
...
<form action="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=site/HTFTData" target="DataFrame" name="DataForm" style="display: none">
    ...
    <input type="hidden" name="Page" value="HTFTOE" />
	<input type="hidden" name="r" value="site/HTFTOEData" />
