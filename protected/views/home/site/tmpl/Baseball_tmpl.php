...
<table id="tmplTable" class="oddsTable" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tbody id="tmplHeader">
    <tr>
      <th width="6%" rowspan="2" title="Time" nowrap="nowrap">Time</th>
      <th colspan="2" rowspan="2" align="left" class="even" title="Event/Pitcher"><div class="text-ellipsis" style="">Event/Pitcher</div></th>
      <th width="55" rowspan="2"  title="Moneyline"><div class="text-ellipsis" style="width:55px;">Moneyline</div></th>
      <th width="80" rowspan="2" title="Run Line"><div class="text-ellipsis" style="width:80px;">Run Line</div></th>
      <th width="80" rowspan="2" class="tabt_R" title="Total Run"><div class="text-ellipsis" style="width:80px;">Total Run</div></th>
      <th colspan="3" class="even tabthup" title="First 5 Innings">First 5 Innings</th>
      <th width="1" rowspan="2">&nbsp;</th>
    </tr>
    <tr class="tabthdwn">
      <th width="50" class="even" title="Moneyline"><div class="text-ellipsis" style="width:80px;">Moneyline</div></th>
      <th width="80" class="even" title="Run Line"><div class="text-ellipsis" style="width:80px;">Run Line</div></th>
      <th width="80" class="even" title="Total Run"><div class="text-ellipsis" style="width:80px;">Total Run</div></th>
    </tr>
  </tbody>
  <tbody id="tmplLeague_L">
    <tr id="l_{%LeagueId}" onclick="refreshData_L()" style="cursor: pointer">
      ...
      <td colspan="2" class="tabtitle" align="right" nowrap><a name="btnRefresh_L" class="btnIcon right disable"><div class="icon-refresh" title="Please Wait"></div></a></td>
    </tr>
  </tbody>
  <tbody id="tmplLive">
    <tr class="{@Tr_Cls}" onmouseover="this.style.backgroundColor='#f5eeb8';" onmouseout="this.style.backgroundColor='{@BgColor}';">
      ...
      <td class="line_unR"><div class="{@Home_Cls}"> {%HomeName} [{%PitcherH}]</div>
        <div class="{@Away_Cls}"> {%AwayName} [{%PitcherA}]</div></td>
      <td align="right" valign="middle" style="white-space: nowrap"> {@SportRadarInfo}{@Streaming}</td>
  ...
  <tbody id="tmplLiveFooter">
    <tr class="{@Tr_Cls}" onmouseover="this.style.backgroundColor='#f5eeb8';" onmouseout="this.style.backgroundColor='{@BgColor}';">
      ...
      <td class="line_unR"><div class="{@Home_Cls}"> {%HomeName} <span class="FavTeamClass">[{%PitcherH}]</span></div>
        <div class="{@Away_Cls}"> {%AwayName} [{%PitcherA}]</div></td>
      <td align="right" valign="middle" style="white-space: nowrap"><div style="float: right;">          
          <div style="display: inline; float: right;"> <div style="display: inline; float: right;" class="{@LS_Status}"><span class="iconOdds info {@LS_Status_IMG}" title="Live Score" onclick="javascript:View_LS(this,'{%MUID}','{%GS}')"></span></div>
          <div style="display: inline; float: right;"> {@Streaming}</div>
<!--img border='0' style="cursor: pointer; padding-right: 2px;" class="{@LS_Status}"
                                src="template/sportsbook/public/images/layout/{@LS_Status_IMG}" onclick="javascript:View_LS(this,'{%MUID}','{%GS}')" /--></div>
          <div style="display: inline; float: right;"> {@SportRadarInfo}</div>
        </div></td>
      <td class="none_rline"><div class="line_divR {%Changed_20}"> <a class="{@Odds_20_H_Cls}" href="javascript:bet({@isParlay},'{%MatchId}','{%OddsId_20}','h','{%Odds_20_H}',20)"> {%Odds_20_H}</a><br />
          <a class="{@Odds_20_A_Cls}" href="javascript:bet({@isParlay},'{%MatchId}','{%OddsId_20}','a','{%Odds_20_A}',20)"> {%Odds_20_A}</a> </div></td>
      <td class="none_rline"><div class="line_divL HdpGoalClass"> {@Value_1_H}<br />
  ...
  <tbody id="tmplLeague">
    <tr id="l_{%LeagueId}" onclick="refreshData_D()" style="cursor: pointer">
      <td class="tabtitle"></td>
      <td colspan="7" class="tabtitle"> {%LeagueName}</td>
      <td colspan="2" class="tabtitle" align="right" nowrap><a name="btnRefresh_D" class="btnIcon right disable"><div class="icon-refresh" title="Please Wait"></div></a></td>
    </tr>
  </tbody>
  <tbody id="tmplEvent">
    <tr class="{@Tr_Cls}" onmouseover="this.style.backgroundColor='#f5eeb8';" onmouseout="this.style.backgroundColor='{@BgColor}';">
