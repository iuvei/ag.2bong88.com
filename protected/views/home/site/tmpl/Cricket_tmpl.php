...
<table id="tmplTable" class="oddsTable" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tbody id="tmplHeader">
    <tr>
      <th width="7%" title=" Time" nowrap="nowrap">Time</th>
      <th width="48%" colspan="2" align="left" class="even" title=" Event">Event</th>
      <th width="6%" align="right" nowrap title="Full Time 1X2">FT. 1X2</th>
      <th width="7%" align="right" nowrap class="even" title=" Moneyline">Moneyline</th>
      <th width="11%" title="Full Time Handicap">FT. HDP</th>
      <th width="11%" title="Full Time Over/Under" class="even">FT. O/U</th>
      <th width="11%" title="Full Time Odd/Even">FT. O/E</th>
  ...
  <tbody id="tmplLeague_L">
    <tr id="l_{%LeagueId}" onclick="refreshData_L()" style="cursor: pointer">
      ...
      <td colspan="2" class="tabtitle" align="right" nowrap><a name="btnRefresh_L" class="btnIcon right disable">
        <div class="icon-refresh" title="Please Wait"></div>
        </a></td>
    </tr>
  </tbody>
  <tbody id="tmplLive">
    <tr class="{@Tr_Cls}" onmouseover="this.style.backgroundColor='#f5eeb8';" onmouseout="this.style.backgroundColor='{@BgColor}';">
      ...
      <td class="line_unR" valign='top'><span class="{@Home_Cls}">{%HomeName}</span><br />
        <span class="{@Away_Cls}">{%AwayName}</span><br />
        {@Draw} </td>
      ...
      <td valign="top"><div class="line_divL line_divR {%Changed_20}"> <a class="{@Odds_20_H_Cls}" href="javascript:bet({@isParlay},'{%MatchId}','{%OddsId_20}','h','{%Odds_20_H}',20)">{%Odds_20_H}</a>
