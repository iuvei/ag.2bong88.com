...
<!-- END langMenu for iPad -->
		...
		<div class="form-register">
			...
			<form method="post" id="register-form">
				...
				<div class="row">
					...
					<input id="txtID" name="username" type="text" maxlength="20" size="10" />
				</div>
				
				<div class="row">
					<span class="titleInput">Email</span>
					<input id="" name="email" type="text" maxlength="200" size="10" />
				</div>
   ...
   <div class="contactBar">Service customer,Please contact. <span class="detail"><strong>Skype: </strong><a href="skype://cs.ibetpm">cs.ibetpm</a><strong>Yahoo Messenger: </strong><a href="mailto:cs.ibetpm@yahoo.com">cs.ibetpm</a><strong>Email: </strong><a href="mailto:cs.ibetpm@gmail.com">cs.ibetpm@gmail.com</a></span>
