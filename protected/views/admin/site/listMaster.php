...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/CustomerList.css?20141215" rel="stylesheet" type="text/css" />
      <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/IcoEdit_Control/Resources/IcoEdit_Control.css?20141215" rel="stylesheet"type="text/css" />
      <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/IcoEditMulti_Control/Resources/IconEditMulti_Control.css?20141215"rel="stylesheet" type="text/css" />
      <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/IcoOther_Control/Resources/IcoOther_Control.css?20141215" rel="stylesheet"type="text/css" />
      <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/IcoStatus_Control/Resources/IcoStatus.css?20141215" rel="stylesheet"type="text/css" />
      <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/IcoViewDownline_Control/Resources/IcoViewDownline_Control.css?20141215"rel="stylesheet" type="text/css" />
      <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/MenuPopup_Control/Resources/MenuPopup_Control.css?20141215" rel="stylesheet"type="text/css" />
   </head>
   <body>
      <table>
         <tr>
      ...
      <table>
         <tr>
            <td>
               <link href="https://mb.b88ag.com/_Components/ErrorMsg/ErrorMsg.css?20141215" rel="stylesheet" type="text/css" />
               <script src="https://mb.b88ag.com/_Components/ErrorMsg/ErrorMsg.js?20141215" type="text/javascript"></script>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <div class="output" id="output" />
                           <script src="https://mb.b88ag.com/_Components/DoubleCommissionSearchUserName_Control/SearchUserName_Control.js?20141215" type="text/javascript"></script><script src="/_Components/DoubleCommissionSearchUserName_Control/autocomplete.js?20141215" type="text/javascript"></script>
                     </td>
                  </tr>
               </table>
               </div>
                  ...
                  <table id="tblCustomerList">
                     ...
                     <tbody>
                        ...
                        <tr class="RowBgOpen" id="<?php echo $user->Id ?>" iconhr="2" iconcs="2" iconbg="2" iconp2p="0" isDisabledP2P="1" iconLiveCasino="1" isDisabledLiveCS="0" iconVirtualSport="2" isDisabledVS="1" iconKeno="2" isDisabledKeno="1" iconEdit="" statusKeno="0">
                           ...
                           <td>
                              <div id="IdStatus"><span class="text" onclick="EditMember_Single('<?php echo $user->Id ?>','<?php echo $user->Username ?>', 15508308, 'Agent');" title="Mở">Mở</span><span onclick="RenderStatus(this,'Popup','<?php echo $user->Id ?>',false,false,0,false, 'chkid_<?php echo $user->Id ?>');" class="arrow" title="Trạng thái">&nbsp;&nbsp;&nbsp</span></div>
                           </td>
                           <td align="center">
                           ...
                           <td>
                              <link href="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/MemberIcoDcomm_Control/Resources/MemberIcoDComm.css?20141215" rel="stylesheet" type="text/css" />
                              <script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Components/MemberIcoDcomm_Control/Resources/MemberIcoDComm.js?20141215" type="text/javascript"></script>
                           ...
                           <td><a href="javascript:OpenIPInfo('<?php echo $user->Ip ?>');" class="iplink"><?php echo $user->Ip ?></a></td>
                           <td class="l">
                              <div class='text' onclick="viewCustOutSt('<?php echo $user->Username ?>',15800254)"><?php echo $user->Username ?></div>
                           </td>
                        </tr>
                       <?php $i++; } ?>
                     </tbody>
      ...
      <div id="divUpdOthers" class="divMenuPopup">
         <div id="tr_racingPT"><a class="LinkPopup" href="javascript:;" id="racingPT" value="0">Racing</a></div>
         <div id="tr_casinoPT"><a class="LinkPopup" href="javascript:;" id="casinoPT" value="0">Casino</a></div>
         <div id="tr_p2pPT"><a class="LinkPopup" href="javascript:;" id="p2pPT" value="0">Poker</a></div>
         <div id="tr_bingoPT"><a class="LinkPopup" href="javascript:;" id="bingoPT" value="0">Bingo</a></div>
         <div id="tr_livecasinoPT"><a class="LinkPopup" href="javascript:;" id="livecasinoPT" value="0">Live Casino</a></div>
         <div id="tr_virtualsportsPT"><a class="LinkPopup" href="javascript:;" id="virtualsportsPT" value="0">Virtual Sports</a></div>
         <div id="tr_kenoPT"><a class="LinkPopup" href="javascript:;" id="kenoPT" value="0">Keno</a></div>
         <div id="tr_editInfo"><a class="LinkPopup" href="javascript:;" id="editInfo" value="0">Thông tin</a></div>
         <div id="tr_betSetting"><a class="LinkPopup" href="javascript:;" id="betSetting" value="0">Tiền Cược</a></div>
         <div id="tr_commission"><a class="LinkPopup" href="javascript:;" id="commission" value="0">Hoa hồng</a></div>
   ...
   <script src="https://mb.b88ag.com/_GlobalResources/Js/Core.js?20141215" type="text/javascript"></script><script src="/assets/js/bet/AGEWnd.js?v=<?php echo time() ?>" type="text/javascript"></script><script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/SportBook.js?20141215" type="text/javascript"></script><script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/Racing.js?20141215" type="text/javascript"></script><script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/P2P.js?20141215" type="text/javascript"></script><script src="/_MemberInfo/CustomerList/Resources/Casino.js?20141215" type="text/javascript"></script><script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/Bingo.js?20141215" type="text/javascript"></script><script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/LiveCasino.js?20141215" type="text/javascript"></script><script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/VirtualSports.js?20141215" type="text/javascript"></script><script src="https://mb.b88ag.com/_MemberInfo/CustomerList/Resources/Keno.js?20141215" type="text/javascript"></script>
	<script src="/assets/js/bet/CustomerList.js?v=<?php echo time() ?>" type="text/javascript"></script>
   </html>
<script type="text/javascript">var _page = {'loginId':15508308,'strConfirmDisableDoubleComm':'\"Bạn có chắc muốn khóa chức năng Nhân đôi hoa hồng với những cá cược bị thua trong Sportbooks của tài khoản này không?\\n\\n Cảnh báo, tất cả những thành viên cấp dưới trực thuộc tài khoản này sẽ đều bị khóa chức năng đó!\"','loginUsername':'TV312888','confirmCloseMemDownline':'Bạn có chắc muốn khóa thành viên này?\\nKhuyến cáo: tất cả cấp dưới của tài khoản này cũng sẽ bị khóa?','isHideTransfer':'1','roleidLiveCasino':1,'confirmCloseMem':'Bạn có chắc muốn thay đổi trạng thái \"Khóa\" của thành viên này không?','strDisallowed':'Đóng','roleid':2,'lblAlertDisableDoubleCommMember':'Bạn có chắc muốn tắt chức năng Nhân đôi hoa hồng đối với  những cá cược bi thua trong Sportbooks  của thành viên này không?','roleidP2P':1,'confirmUnSuspendDownline':'Bạn có chắc muốn bỏ trạng thái \"Đình Chỉ\" cho thành viên này không? Khuyến cáo: tất cả cấp dưới trực thuộc thành viên này sẽ được bỏ trạng thái \"Đình Chỉ\".','strAllowed':'Mở','lblConfirmClearCredit':'Bạn có chắc sẻ thu hồi hạn mức tín dụng của tài khoản { tên đăng nhập } này?','confirmUnSuspendMem':'Bạn có chắc muốn thay đổi trạng thái \"Đình Chỉ\" cho thành viên này không?','confirmDisableNumberGameDownline':'Bạn có chắc muốn chặn thành viên này chơi Number Game?','roleidVirtualSports':1,'custid':15508308,'langKey':'VI','confirmSuspendDownline':'Bạn có chắc muốn đình chỉ thành viên này?\\n Khuyến cáo, tất cả cấp dưới trực thuộc thành viên này sẽ không thể đặt cược?','isAgentLevel':1,'confirmSuspendMem':'Bạn có chắc muốn đình chỉ thành viên này?\\n Khuyến cáo: thành viên này sẽ không thể đặt cược?','strConfirmEnableDoubleComm':'Bạn có chắc muốn cho phép sử dụng chức năng Nhân đôi hoa hồng đối với những cá cược bị thua trong Sportbooks của tài khoản này không?','usernamedefault':'Tên đăng nhập hoặc Tên/Họ','strConfirmEnableDoubleCommMember':'Bạn có chắc muốn mở chức năng Nhân đôi hoa hồng đối với những cá cược bi thua trong Sportbooks  của thành viên này không?','subUserName':''};</script>