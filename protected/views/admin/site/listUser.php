...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
      ...
      <table>
         ...
         <tr>
            <td>
               <div id="title_header">Danh sách Agent &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:getPrint('page_main');" id="imgPrint" title="In"></a></div>
            </td>
         </tr>
         <tr>
            <td>
               ...
               <div id="page_main">
                  ...
                  <table id="tblCustomerList">
                     ...
                     <tbody>
                        ...
                        <tr class="RowBgOpen" id="<?php echo $user->Id ?>" iconhr="2" iconcs="2" iconbg="2" iconp2p="0" isDisabledP2P="1" iconLiveCasino="0" isDisabledLiveCS="0" iconVirtualSport="2" isDisabledVS="1" iconKeno="2" isDisabledKeno="1" iconEdit="" statusKeno="0">
                           <td><?php echo $i; ?></td>
                           ...
                           <td>
                              <div id="IdStatus"><span class="text" onclick="EditMember_Single('<?php echo $user->Id ?>','<?php echo $user->username ?>', <?php echo $user->parentUser ?>, 'Agent');" title="<?php echo ($user->status==1)?"Mở":(($user->status==2)?"Khóa":"Đình chỉ"); ?>"><?php echo ($user->status==1)?"Mở":(($user->status==2)?"Khóa":"Đình chỉ"); ?></span><span onclick="RenderStatus(this,'Popup','<?php echo $user->Id ?>',false,false,0,false, 'chkid_<?php echo $user->Id ?>');" class="arrow" title="Trạng thái">&nbsp;&nbsp;&nbsp</span></div>
                           </td>
                           <td align="center">
                           ...
                           <td class="l"><?php echo $user->nickname ?></td>
                           <td class="l"><?php echo ($user->settingOptions!="")?json_decode($user->settingOptions)->firstName:"" ?></td>
                           <td class="l"><?php echo ($user->settingOptions!="")?json_decode($user->settingOptions)->lastName:"" ?></td>
                           <td>a</td>
                           <td>0.0025</td>
                           <td>0.0025</td>
                           <td>0.01</td>
                           ...
                           <td>0.01</td>
                           <td>0</td>
                           <td class="bl_time"><?php echo date("d/m/Y H:i:s",$user->lastLogin) ?></td>
                           <td><a href="javascript:;" class="iplink"><?php echo $user->ipLogin ?></a></td>
                           <td class="l">
                              <div class='text' onclick="viewCustOutSt('<?php echo $user->username ?>',<?php echo $user->Id ?>)"><?php echo $user->username ?></div>
                           </td>
                        </tr>
      ...
      <div id="divUpdOthers" class="divMenuPopup">
         <div id="tr_racingPT" style=""><a class="LinkPopup" href="javascript:;" id="racingPT" value="0">Racing</a></div>
         <div id="tr_casinoPT" style=""><a class="LinkPopup" href="javascript:;" id="casinoPT" value="0">Casino</a></div>
         <div id="tr_p2pPT" style=""><a class="LinkPopup" href="javascript:;" id="p2pPT" value="0">Poker</a></div>
         <div id="tr_bingoPT" style=""><a class="LinkPopup" href="javascript:;" id="bingoPT" value="0">Bingo</a></div>
         <div id="tr_livecasinoPT" style=""><a class="LinkPopup" href="javascript:;" id="livecasinoPT" value="0">Live Casino</a></div>
         <div id="tr_virtualsportsPT" style=""><a class="LinkPopup" href="javascript:;" id="virtualsportsPT" value="0">Virtual Sports</a></div>
         <div id="tr_kenoPT" style=""><a class="LinkPopup" href="javascript:;" id="kenoPT" value="0">Keno</a></div>
         <div id="tr_editInfo" style=""><a class="LinkPopup" href="javascript:;" id="editInfo" value="0">Thông tin</a></div>
         <div id="tr_betSetting" style=""><a class="LinkPopup" href="javascript:;" id="betSetting" value="0">Tiền Cược</a></div>
         <div id="tr_commission" style=""><a class="LinkPopup" href="javascript:;" id="commission" value="0">Hoa hồng</a></div>
   ...
   <script src="/assets/js/bet/AGEWnd.js?v=<?php echo time() ?>" type="text/javascript"></script>
   <script src="/assets/js/bet/SportBook.js?20150328" type="text/javascript"></script>
   ...
   <script src="/assets/js/bet/LiveCasino.js?20141215" type="text/javascript">
   </script><script src="/assets/js/bet/VirtualSports.js?20141215" type="text/javascript"></script>
