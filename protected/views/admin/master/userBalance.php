            ...
            <td>
                <div id="page_main">
                    ...
                    <div id="tbl-container">
                                ...
                                <tbody>
									...
									<?php $class = ($i%2==0)?"BgEven":"BgOdd"; ?>
                                     <tr class="<?php echo $class ?>">
                                        ...
                                        <td class="FN l">&nbsp;</td>
                                        <td class="LN l">&nbsp;</td>
                                        <td class="CD r"><a href="javascript:void('');" onclick="openTransfer('<?php echo $u->Id ?>','<?php echo $u->givenCredit ?>','<?php echo $u->Username ?>','{RoleId}','superMaster');return false;"><?php echo number_format($u->givenCredit) ?></a>
                                        </td>
                                        <td class="BL r"></td>
                                        <td class="YB r"><font color='#1e1eeb'>0<font></td>
										<td class="BC r"><?php echo $u->Credit ?></td>
										<td class="LCS r">Không giới hạn</td>
										<td class="OT r"><a href="javascript:;"><?php echo $u->getTotalOutStanding(); ?></a></td>
						...
						<script type="text/javascript" src="/assets/js/bet/CreditBalanceList.js?v=<?php echo time(); ?>"></script>
