...
<head>
    ...
    <script src='/azkv.php?r=adminweb/getCusSetting&id=0&type=admin' type="text/javascript"></script>
        ...
        <div class="minWidthCustomer">
            ...
            <div class="customerInfo">
                ...
                <div class="clearBlock">
                    ...
                    <div class="customerInfoBlock2"><b><span></span></b>
                        <select id="selectedOne" name="selectedOne"></select>
                        
						<span id="msgIcon">&nbsp;&nbsp;&nbsp;</span></div>
...
Lưu ý : Mật khẩu có phân biệt chữ hoa và chữ thường.">
    ...
    <script language="javascript" type="text/javascript">
		...
		var urlCreate = '/azkv.php?r=ProSuperMaster/AddNewUser';
    </script>
   <script src='/assets/js/bet/Core.js?20150304' type='text/javascript'></script>
    ...
    <script src='/assets/js/bet/MemberInfo.js?v=<?php echo time(); ?>' type='text/javascript'></script>
    <script src='/assets/js/bet/AddNewMember.js?v=<?php echo time(); ?>' type='text/javascript'></script>
</body>
