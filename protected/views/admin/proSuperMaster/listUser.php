                  ...
                  <table id="tblCustomerList">
                     ...
                     <tbody>
                        ...
                        <tr class="RowBgOpen" id="<?php echo $user->Id ?>" iconhr="2" iconcs="2" iconbg="2" iconp2p="0" isDisabledP2P="1" iconLiveCasino="1" isDisabledLiveCS="0" iconVirtualSport="2" isDisabledVS="1" iconKeno="2" isDisabledKeno="1" iconEdit="" statusKeno="0">
                           ...
                           <td>
                              <div id="IdStatus"><span class="text" onclick="EditMember_Single('<?php echo $user->Id ?>','<?php echo $user->Username ?>', <?php echo $user->Id ?>, 'Agent');" title="<?php echo ($user->status==1)?"Mở":(($user->status==2)?"Khóa":"Đình chỉ"); ?>"><?php echo ($user->status==1)?"Mở":(($user->status==2)?"Khóa":"Đình chỉ"); ?></span><span onclick="RenderStatus(this,'Popup','<?php echo $user->Id ?>',false,false,0,false, 'chkid_<?php echo $user->Id ?>');" class="arrow" title="Trạng thái">&nbsp;&nbsp;&nbsp</span></div>
                           </td>
                           <td align="center">
