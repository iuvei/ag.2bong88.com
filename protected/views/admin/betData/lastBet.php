        ...
        <div id="page_main">
            ...
            <div id="Content">
                <div id="box_header">
                    <table width="100%">
                        <tr class="l">
                            <td nowrap id="BetTypeGroup999" class="c selectedBetType"><a href="javascript:LoadDataByBetType(_page.BetTypes_All);">Tất cả loại cược</a></td>
                            ...
                            <td nowrap id="BetTypeGroup1999" class="c"><a href="javascript:LoadDataByBetType(_page.BetTypes_Others);">Các loại cược khác</a></td>
                            <td nowrap style="display: none;" id="BetTypeGroup0" class="c"><a href="javascript:LoadDataByBetType(_page.BetTypes_All);">Tất cả loại cược</a></td>
