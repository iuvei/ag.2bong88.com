...
<?php 
	...
	$betLimitAdmin = json_decode($admin->settingOptions)->bettingLimit->BettingLimitItems;
	$betLimitUser = json_decode($user->settingOptions)->bettingLimit->BettingLimitItems;
	?>
var customer = {
    ...
    "bettingLimitItems": [
      {
        ...
        "key": "Soccer",
        "resourceKey": "Soccer",
        "minBet": <?php echo $betLimitUser[0]->MinBet ?>,
        "maxBet": <?php echo $betLimitUser[0]->MaxBet ?>,
        "maxPerMatch": <?php echo $betLimitUser[0]->MaxPerMatch ?>,
        "minBetMax": <?php echo $betLimitAdmin[0]->MinBet ?>,
        "maxBetMin": <?php echo $betLimitAdmin[0]->MaxBet ?>,
        "maxPerMatchMin": 0.0000,
        "maxPerMatchMax": <?php echo $betLimitAdmin[0]->MaxPerMatch ?>
      },
      {
        "id": 2,
        "betTypeId": 0,
