...
topFrame.location='index.php?r=site/topMenu#top';
}
else
{
setframevalue(columntype, contractsetting)
topFrame.location='index.php?r=site/topMenu#collapse';
}
}
function SwitchLefthideshow()
{  
	parent.document.getElementById("frameset1").cols=parent.document.getElementById("frameset1").cols=="0,*,0" ? "198,*,0":"0,*,0";  
} 
